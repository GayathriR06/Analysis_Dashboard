    ...
    <Box m="20px">
      <Box display="flex" alignItems="center" mb="20px">
        ...
        <IconButton
          ...
          sx={{ mr: 2,mb:5, borderRadius: "50%" }}
        >
          <ArrowBackIcon sx={{ color: colors.primary[400], fontSize: "24px" }} />
        </IconButton>
        {/* Header */}
        <Header title="Kolhapur - KOP" subtitle="Analytics of Kolhapur Station Complaints" />
      </Box>
      <Box
        display="grid"
